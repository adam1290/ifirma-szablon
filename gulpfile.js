// Generated on 2016-09-02 using generator-jhipster 3.6.1
'use strict';
...
gulp.task('inject:css', function () {
    return gulp.src(config.app + 'index.html')
        ...
        .pipe(inj(gulp.src('src/main/webapp/content/mycss/**/*.css', { read: false }), { ignorePath: 'src/main/webapp/', addRootSlash: false }))
...
gulp.task('sass:css', function () {
    return gulp.src(config.app + 'app/**/*.scss')
        .pipe(sass().on('error', sass.logError))
        .pipe(gulp.dest(config.app+"/content/mycss"));
});
/*************************/
/******* Watch sass *******/
gulp.task('sass:watch', function () {
    gulp.watch(config.app + 'app/**/*.scss', ['sass:css', 'inject:css']);
});
/*************************/
/******* All tasks *******/
gulp.task('alltasks', function () {
    runSequence('sass:watch', ['sass:css', 'inject:css']);
});
/*************************/
...
gulp.task('install', function () {
    runSequence(['inject:dep', 'ngconstant:dev'], 'sass', 'inject:app', 'inject:troubleshoot', 'alltasks');
});
